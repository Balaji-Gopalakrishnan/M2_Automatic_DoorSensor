...
NOTE : In my project I am implement the switch instead of using PIR Sensor,Because in simulIDE platform there is no available of the PIR Sensor.
 ...
 * To design and develop a prototype for an automated open door that can open  and close the  automatically when it recognises infrared energy produced by the human body.
